 ...
 *
 * @example StartNode,CancelNode,FinishNode,DecisionNode,SplitNode,JoinNode,OperationCallNode,Arithmetic,CastNode,TemporaryVariable,ActivityParameter,DataFlowEdge,ExecutionEdge,ActivityOperation
 *		A summary of all of the elements used in {@model ActivityOperation Operational Modelling}.
 */
