...
public class Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case org.openiaml.model.model.scopes.Package.SITE_SCOPE: {
				SiteScope siteScope = (SiteScope)theEObject;
				T result = caseSiteScope(siteScope);
				if (result == null) result = caseNamedElement(siteScope);
				if (result == null) result = caseScope(siteScope);
				if (result == null) result = caseContainsOperations(siteScope);
				if (result == null) result = caseGeneratedElement(siteScope);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Site Scope</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Site Scope</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSiteScope(SiteScope object) {
		return null;
	}
