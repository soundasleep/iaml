...
public class SelectWireAttributeInference extends InferenceActionTestCase {
	...
	protected void initialTests() throws Exception {
		...
		DomainObject dobj = (DomainObject) queryOne(page, "iaml:children[iaml:name='a domain object']");
		DomainObjectInstance di = (DomainObjectInstance) queryOne(page, "iaml:children[iaml:name='instance']");
		InputForm form = (InputForm) queryOne(page, "iaml:children[iaml:name='form']");
	...
	protected void checkInferredKnowledge() throws Exception {
		...
		DomainAttribute key = (DomainAttribute) queryOne(dobj, "iaml:attributes[iaml:name='generated primary key']");
