...
abstract class BaseEventPeer {
	...
	/** the column name for the TICKETS_LEFT field */
	const TICKETS_LEFT = 'event.TICKETS_LEFT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'Venue', 'Date', 'TicketsLeft', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'venue', 'date', 'ticketsLeft', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::DESCRIPTION, self::VENUE, self::DATE, self::TICKETS_LEFT, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'venue', 'date', 'tickets_left', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'Venue' => 3, 'Date' => 4, 'TicketsLeft' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'venue' => 3, 'date' => 4, 'ticketsLeft' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::DESCRIPTION => 2, self::VENUE => 3, self::DATE => 4, self::TICKETS_LEFT => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'venue' => 3, 'date' => 4, 'tickets_left' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EventPeer::VENUE);
		$criteria->addSelectColumn(EventPeer::DATE);
		$criteria->addSelectColumn(EventPeer::TICKETS_LEFT);
	...
	{
		// invalidate objects in TicketPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			EventPeer::doOnDeleteSetNull(new Criteria(EventPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			EventPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Ticket rows to NULL
			$selectCriteria = new Criteria(EventPeer::DATABASE_NAME);
			$updateValues = new Criteria(EventPeer::DATABASE_NAME);
			$selectCriteria->add(TicketPeer::EVENT_ID, $obj->getId());
			$updateValues->add(TicketPeer::EVENT_ID, null);
