 ...
 *
 */
public class OAWGenerator {
	
	public static final String PLUGIN_ID = VerificationNuSMVPlugin.PLUGIN_ID; 
	
	/**
	 * Generate the output for a given model file.
	 * 
	 * <p>TODO refactor along with other implementations of OAW codegen
	 * 
	 * @param file the model file
	 * @param wffile the workflow file (e.g. <code>src/workflow/foo.oaw</code>)
	 */
	public IStatus generateCode(File file, String wfFile) {
