...
import org.openiaml.model.model.wires.SelectEdge;
...
public abstract class EcoreCreateElementsHelper implements ICreateElements {
	...
	public DomainSchema generatedDomainSchema(GeneratesElements by, InternetApplication container) throws InferenceException {
		DomainSchema ds = (DomainSchema) createElement( container, DomainPackage.eINSTANCE.getDomainSchema(), ModelPackage.eINSTANCE.getInternetApplication_Schemas() );
	...
	public SelectEdge generatedSelectEdge(GeneratesElements by, ContainsWires container, WireSource source, WireDestination target) throws InferenceException {
		SelectEdge wire = (SelectEdge) createRelationship(container, WiresPackage.eINSTANCE.getSelectEdge(), source, target, ModelPackage.eINSTANCE.getContainsWires_SelectEdges(), WiresPackage.eINSTANCE.getSelectEdge_From(), WiresPackage.eINSTANCE.getSelectEdge_To());
		setGeneratedBy(wire, by);
		return wire;
	}
	...
	public DomainSource generatedDomainSource(GeneratesElements by, InternetApplication container) throws InferenceException {
		DomainSource object = (DomainSource) createElement( container, DomainPackage.eINSTANCE.getDomainSource(), ModelPackage.eINSTANCE.getInternetApplication_Sources() );
		setGeneratedBy(object, by);
		return object;
	}

	public DomainSource generatedDomainSource(GeneratesElements by, DomainSource container) throws InferenceException {
		DomainSource object = (DomainSource) createElement( container, DomainPackage.eINSTANCE.getDomainSource(), DomainPackage.eINSTANCE.getDomainSource_Children() );
		setGeneratedBy(object, by);
		return object;
	}

	public DomainAttribute generatedDomainAttribute(GeneratesElements by, DomainSchema container) throws InferenceException {
		DomainAttribute object = (DomainAttribute) createElement( container, ModelPackage.eINSTANCE.getDomainAttribute(), DomainPackage.eINSTANCE.getDomainSchema_Attributes() );
		setGeneratedBy(object, by);
		return object;
	}
	...
	public Role generatedRole(GeneratesElements by, InternetApplication container) throws InferenceException {
		Role object = (Role) createElement( container, UsersPackage.eINSTANCE.getRole(), ModelPackage.eINSTANCE.getInternetApplication_Schemas() );
		setGeneratedBy(object, by);
		return object;
	}
	...
	public void setQuery(DomainObjectInstance element, String value) throws InferenceException {
		setValue(element, ModelPackage.eINSTANCE.getDomainObjectInstance_Query(), value);
	}
	...
	public void setLimit(DomainObjectInstance element, int value) throws InferenceException {
		setValue(element, ModelPackage.eINSTANCE.getDomainObjectInstance_Limit(), value);
	}
