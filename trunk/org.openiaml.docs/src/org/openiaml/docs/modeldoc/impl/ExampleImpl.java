 ...
 * @generated
 */
public class ExampleImpl extends SemanticImpl implements Example {
	/**
	...
	public JavadocTagElement getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModeldocPackage.EXAMPLE__DESCRIPTION, oldDescription, description));
			}
		}
		return description;
	}
	...
	public void setDescription(JavadocTagElement newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldocPackage.EXAMPLE__DESCRIPTION, oldDescription, description));
	}
