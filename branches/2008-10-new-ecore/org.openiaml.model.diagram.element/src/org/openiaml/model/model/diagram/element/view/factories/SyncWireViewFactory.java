package org.openiaml.model.model.diagram.element.view.factories;
...
import org.openiaml.model.model.diagram.element.edit.parts.SyncWireEditPart;
import org.openiaml.model.model.diagram.element.edit.parts.SyncWireNameEditPart;
...
public class SyncWireViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		super.decorateView(containerView, view, semanticAdapter, semanticHint,
				index, persisted);
		// start manual
		if (!ApplicationElementEditPart.MODEL_ID.equals(IamlVisualIDRegistry
				.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", ApplicationElementEditPart.MODEL_ID); //$NON-NLS-1$
