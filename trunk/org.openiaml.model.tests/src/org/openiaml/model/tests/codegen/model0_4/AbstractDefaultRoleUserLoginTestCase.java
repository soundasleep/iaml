...
public abstract class AbstractDefaultRoleUserLoginTestCase extends AbstractUserLoginTestCase {
	...
	protected List<String> getDatabaseInitialisers() {
		...
		s.add("CREATE TABLE Permissions_User (generated_primary_key INTEGER PRIMARY KEY, a_permission INTEGER, a_different_permission INTEGER, inherited_permission INTEGER)");
		s.add("INSERT INTO Permissions_User (generated_primary_key, a_permission, a_different_permission, inherited_permission) VALUES (22, 1, 0, 1)");
		s.add("INSERT INTO Permissions_User (generated_primary_key, a_permission, a_different_permission, inherited_permission) VALUES (66, 0, 1, 1)");
		s.add("INSERT INTO Permissions_User (generated_primary_key, a_permission, a_different_permission, inherited_permission) VALUES (77, 1, 1, 1)");
