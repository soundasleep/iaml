...
public class NonContainedEdges extends AbstractActionTestCase<GraphicalEditPart> {
	...
	public void testInitial() throws Exception {
		...
		assertHasApplicationElementProperty(editor, "target property", false);
	...
	public void testConditionEditor() throws Exception {
		...
		ShapeNodeEditPart property = assertHasApplicationElementProperty(editor, "target property", false);
		...
		ShapeNodeEditPart property2 = assertHasApplicationElementProperty(editor_sub, "target property", true);
		...
		try {
			new org.openiaml.model.model.diagram.condition.edit.commands.DataFlowEdgeCreateCommand(null, property2.resolveSemanticElement(), var.resolveSemanticElement(), new ArrayList<EObject>());
	...
	public void testOperationEditor() throws Exception {
		...
		// it should throw a NullPointerException
		try {
			new org.openiaml.model.model.diagram.operation.edit.commands.DataFlowEdgeCreateCommand(null, property2.resolveSemanticElement(), var.resolveSemanticElement(), new ArrayList<EObject>());
			fail("Should have thrown a NullPointerException");
		} catch (NullPointerException e) {
			// expected
		}
