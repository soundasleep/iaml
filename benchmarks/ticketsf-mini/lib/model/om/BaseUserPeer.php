...
abstract class BaseUserPeer {
	...
	/** the column name for the IS_MANAGER field */
	const IS_MANAGER = 'user.IS_MANAGER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Password', 'IsManager', 'IsAdmin', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'password', 'isManager', 'isAdmin', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::PASSWORD, self::IS_MANAGER, self::IS_ADMIN, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'password', 'is_manager', 'is_admin', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Password' => 2, 'IsManager' => 3, 'IsAdmin' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'isManager' => 3, 'isAdmin' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::PASSWORD => 2, self::IS_MANAGER => 3, self::IS_ADMIN => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'is_manager' => 3, 'is_admin' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::IS_MANAGER);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(TicketPeer::USER_ID, $obj->getId());
			$updateValues->add(TicketPeer::USER_ID, null);
