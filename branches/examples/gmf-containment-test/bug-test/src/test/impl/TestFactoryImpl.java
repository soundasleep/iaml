...
public class TestFactoryImpl extends EFactoryImpl implements TestFactory {
	...
	public static TestFactory init() {
		try {
			TestFactory theTestFactory = (TestFactory)EPackage.Registry.INSTANCE.getEFactory("http://test.com/test"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestPackage.EDGE: return createEdge();
			case TestPackage.ROOT: return createRoot();
