...
/**
 * Tests creating new instances in sessions.
 * 
 * @author jmwright
 *
 */
public class NewInstanceAttributeSession extends DatabaseCodegenTestCase {
	...
	public void testNewInstance() throws Exception {
		...
		// go to sitemap
		IFile sitemap = beginAtSitemapThenPage("session page");
