...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	/**
	 * Set the value of [is_manager] column.
	 * 
	...
	public function setIsManager($v)
	{
		...
		if ($this->is_manager !== $v || $this->isNew()) {
			$this->is_manager = $v;
			$this->modifiedColumns[] = UserPeer::IS_MANAGER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_manager = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIsManager($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::IS_MANAGER)) $criteria->add(UserPeer::IS_MANAGER, $this->is_manager);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsManager($this->is_manager);
	 ...
	 * related Tickets from storage. If this User is new, it will return
	 ...
	 */
	public function getTicketsJoinEvent($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collTickets === null) {
			if ($this->isNew()) {
				...
				$this->collTickets = TicketPeer::doSelectJoinEvent($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
