...
public abstract class OperationImpl extends EObjectImpl implements Operation {
		...
		if (generatedBy != null && generatedBy.eIsProxy()) {
			...
			if (generatedBy != oldGeneratedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.OPERATION__GENERATED_BY, oldGeneratedBy, generatedBy));
			}
		}
		return generatedBy;
	}
	...
	public NotificationChain basicSetGeneratedBy(GeneratesElements newGeneratedBy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.OPERATION__GENERATED_BY, oldGeneratedBy, newGeneratedBy);
	...
	public void setGeneratedBy(GeneratesElements newGeneratedBy) {
		if (newGeneratedBy != generatedBy) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OPERATION__GENERATED_BY, newGeneratedBy, newGeneratedBy));
	}
