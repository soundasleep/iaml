...
abstract class BaseTicketPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'EventId', 'UserId', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'eventId', 'userId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EVENT_ID, self::USER_ID, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'event_id', 'user_id', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'EventId' => 1, 'UserId' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'eventId' => 1, 'userId' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EVENT_ID => 1, self::USER_ID => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'event_id' => 1, 'user_id' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TicketPeer::EVENT_ID);
		$criteria->addSelectColumn(TicketPeer::USER_ID);
		$criteria->addSelectColumn(TicketPeer::CREATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseTicketPeer', $criteria, $con);
		}
	...
	public static function doCountJoinEvent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketPeer::EVENT_ID, EventPeer::ID, $join_behavior);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Ticket objects pre-filled with their Event objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Ticket) to $obj2 (Event)
				$obj2->addTicket($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Ticket) to the collection in $obj2 (Event)
				$obj2->addTicket($obj1);
	...
	/**
	 * Selects a collection of Ticket objects pre-filled with all related objects except Event.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = TicketPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Ticket) to the collection in $obj2 (User)
				$obj2->addTicket($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTicketPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseTicketPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTicketPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseTicketPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTicketPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseTicketPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTicketPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseTicketPeer', $values, $con, $ret);
    }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseTicketPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
