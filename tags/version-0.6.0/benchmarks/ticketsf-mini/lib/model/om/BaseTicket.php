...
abstract class BaseTicket extends BaseObject  implements Persistent {
	...
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = TicketPeer::EVENT_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = TicketPeer::USER_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TicketPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TicketPeer::NUM_COLUMNS - TicketPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TicketPeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TicketPeer::EVENT_ID)) $criteria->add(TicketPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(TicketPeer::USER_ID)) $criteria->add(TicketPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(TicketPeer::CREATED_AT)) $criteria->add(TicketPeer::CREATED_AT, $this->created_at);
