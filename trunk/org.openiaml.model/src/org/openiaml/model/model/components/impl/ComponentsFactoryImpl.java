...
public class ComponentsFactoryImpl extends EFactoryImpl implements ComponentsFactory {
	 ...
	 * @generated NOT
	 */
	public AccessControlHandler createAccessControlHandler() {
		AccessControlHandlerImpl accessControlHandler = new AccessControlHandlerImpl();
		generateID(accessControlHandler);
