 ...
 * <ul>
 *   <li>{@link org.openiaml.model.model.wires.impl.RunInstanceWireImpl#getInWires <em>In Wires</em>}</li>
...
public class RunInstanceWireImpl extends EObjectImpl implements RunInstanceWire {
	...
	public EList<Wire> getInWires() {
		if (inWires == null) {
			inWires = new EObjectWithInverseResolvingEList<Wire>(Wire.class, this, WiresPackage.RUN_INSTANCE_WIRE__IN_WIRES, ModelPackage.WIRE__TO);
		}
		return inWires;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WiresPackage.RUN_INSTANCE_WIRE__IN_WIRES:
