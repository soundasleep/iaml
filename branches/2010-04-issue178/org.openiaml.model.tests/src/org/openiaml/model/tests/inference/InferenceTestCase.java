...
public abstract class InferenceTestCase extends ModelInferenceTestCase {
	...
	public DomainAttribute assertHasDomainAttribute(DomainSchema obj,
		...
		return (DomainAttribute) assertOne(nameSelect(typeSelect(obj.getAttributes(), DomainAttribute.class), string));
	}
	 ...
	 * @return The element found
	 */
	public DomainSchema assertHasDomainSchema(InternetApplication root, String string) throws JaxenException {
		return (DomainSchema) assertOne(nameSelect(typeSelect(root.getSchemas(), DomainSchema.class), string)); 
	}
	 ...
	 * @return The element found
	 */
	public Role assertHasRole(InternetApplication root, String string) throws JaxenException {
		return (Role) assertOne(nameSelect(typeSelect(root.getSchemas(), Role.class), string));
	}
	
	public Object assertOne(List<?> results) {
		assertEquals(1, results.size());
	 ...
	 * @return The element found
	 */
	public SelectEdge assertHasSelectEdge(DomainObjectInstance from, DomainSource to) throws JaxenException {
		SelectEdge result = null;
		for (SelectEdge edge : from.getSelectEdges()) {
		...
		assertNotNull("Could not find any SelectEdge between '" + from + "' to '" + to + "'", result);
		return result;		
	}
