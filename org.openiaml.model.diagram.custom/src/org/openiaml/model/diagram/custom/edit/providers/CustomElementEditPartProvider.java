...
import org.openiaml.model.diagram.custom.commands.CreateMissingElementShortcutsCommand;
...
import org.openiaml.model.model.diagram.element.providers.IamlEditPartProvider;
 ...
 *
 */
public class CustomElementEditPartProvider extends IamlEditPartProvider {
	...
	public IGraphicalEditPart createGraphicEditPart(View view) {
		...
		if (part instanceof ApplicationElementEditPart) {
			...
			part.addEditPartListener(new EditPartListener() {
				...
				public void partActivated(EditPart editpart) {
					if (editpart instanceof GraphicalEditPart) {
						...
						ICommand command = new CreateMissingElementShortcutsCommand((GraphicalEditPart) editpart, 
									IamlDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT, 
									ApplicationElementEditPart.MODEL_ID);
