...
public abstract class PhpCodegenTestCase extends CodegenTestCase {
	...
	public void setUp() throws Exception {
		super.setUp();
		root = loadAndCodegen(PhpCodegenTestCase.class, ModelSourceResolver.getInstance().getAbsolutePathRoot() + ROOT + "codegen/runtime/server/PhpCodegenTestCase.iaml");
		hasStarted = false;
	}
	 ...
	 * @throws Exception 
	 */
	public void assertPhpResult(long expected, String init, String script) throws Exception {
		assertPhpResult(Long.toString(expected), init, script);
