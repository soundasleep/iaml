...
public class SyncFieldDomainAttribute extends InferenceTestCase {
	...
	public void testInference() throws JaxenException {
		...
		DomainSchema store = assertHasDomainSchema(root, "store");
		DomainSource obj = assertHasDomainSource(root, "domain");
		DomainAttribute attribute = assertHasDomainAttribute(store, "attribute");
